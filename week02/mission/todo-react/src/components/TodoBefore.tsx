...
const TodoBefore = () : Element => {
    ...
    const handdleSubmit = (e: FormEvent<HTMLFormElement>) : void =>{
        e.preventDefault();
        console.log('동작함')
    ...
    return(
        <div className="todo-container">
            ...
            <form onSubmit={handdleSubmit} className="todo-container__form">
                <input
                value={input}
            ...
            <div className="render-container">
                <div className="render-container__section">
                    ...
                    <ul id="todo-list" className="render_container__list">
                        {todos.map((todo) => (
