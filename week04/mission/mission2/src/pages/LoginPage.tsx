    ...
    return( 
        <div className="flex flex-col items-center justify-center h-full gap-4">
            <div className="flex flex-col gap-3">
                <div className="flex">
                    <button
                        className="hover:bg-gray-100 font-bold w-[30px] rounded-md"
                        onClick={handleGoBack}>
                        {"<"}
                    </button>
                    <h1 className="flex-1 text-center font-bold text-2xl">로그인</h1>
                </div>
                <input
                    {...getInputProps("email")}
                    name="email"
...
function getInputProps(arg0: string): import("react/jsx-runtime").JSX.IntrinsicAttributes & import("react").ClassAttributes<HTMLInputElement> & import("react").InputHTMLAttributes<HTMLInputElement> {
